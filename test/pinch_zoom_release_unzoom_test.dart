...
void main() {
  testWidgets('PinchZoomReleaseUnzoomWidget changes scale when pinched',
    ...
    final Offset secondPointerStart =
        tester.getCenter(find.byKey(key)) + const Offset(0, -20);
    ...
    final TestGesture firstGesture =
        await tester.startGesture(firstPointerStart);
    await tester.pump();
    final TestGesture secondGesture =
        await tester.startGesture(secondPointerStart);
    await tester.pump();
